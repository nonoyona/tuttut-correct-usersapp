<template>
  <div class="content">
    ...
    <ul class="index">
      ...
      <li>
        <a class="index-link" href="#m29">Cloud-Dienste</a>
      </li>
      <li>
    ...
    <p>
      Noah-Yannick Schmid
      <br />Erdmannhäuser Straße 15
      <br />70439 Stuttgart
    </p>
    <p>
      <strong>E-Mail-Adresse:</strong>
      <a href="mailto:hundred.percent@outlook.de">hundred.percent@outlook.de</a>
    </p>
    ...
    <p>
      ...
      <a
        ...
        target="_blank"
      >https://www.youronlinechoices.com/</a> erklärt werden. Daneben können Sie weitere Widerspruchshinweise im Rahmen der Angaben zu den eingesetzten Dienstleistern und Cookies erhalten.
    </p>
    <ul class="m-elements">
      <li>
    ...
    <ul class="m-elements">
      <li>
        <strong>1&1 IONOS:</strong> Hostingplattform für E-Commerce / Websites; Dienstanbieter: 1&1 IONOS SE, Elgendorfer Str. 57, 56410 Montabaur, Deutschland; Website:
        <a href="https://www.ionos.de" target="_blank">https://www.ionos.de</a>; Datenschutzerklärung:
        <a
    ...
    <p>Es wird über Firebase Hosting gehostet.</p>
    ...
    <ul class="m-elements">
      <li>
        ...
        <a
          ...
          target="_blank"
        >https://www.google.com/policies/privacy</a>, Sicherheitshinweise:
        <a
          href="https://cloud.google.com/security/privacy"
          target="_blank"
        >https://cloud.google.com/security/privacy</a>; Privacy Shield (Gewährleistung Datenschutzniveau bei Verarbeitung von Daten in den USA):
        <a
          href="https://www.privacyshield.gov/participant?id=a2zt0000000000001L5AAI&status=Aktive"
          target="_blank"
        >https://www.privacyshield.gov/participant?id=a2zt0000000000001L5AAI&status=Aktive</a>; Standardvertragsklauseln (Gewährleistung Datenschutzniveau bei Verarbeitung in Drittländern):
        <a
          href="https://cloud.google.com/terms/data-processing-terms"
          target="_blank"
        >https://cloud.google.com/terms/data-processing-terms</a>; Zusätzliche Hinweise zum Datenschutz:
        <a
          href="https://cloud.google.com/terms/data-processing-terms"
          target="_blank"
    ...
    <ul class="m-elements">
      ...
      <li>
        <strong>Zwecke der Verarbeitung:</strong> Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit, Vertragliche Leistungen und Service.
      </li>
      <li>
        <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f. DSGVO).
      </li>
